...
export const AUSPICIOUS_TITHIS = new Set([2, 3, 5, 7, 10, 11, 12, 13, 15]);
 ...
 *  Traditional sequence: Sun=8, Mon=2, Tue=7, Wed=5, Thu=6, Fri=4, Sat=3 */
export const RAHU_KALAM_PERIODS = [8, 2, 7, 5, 6, 4, 3] as const;
export const GULIKA_KALAM_PERIODS = [7, 6, 5, 4, 3, 2, 1] as const;
/** Yamaganda: Sun=5, Mon=4, Tue=3, Wed=2, Thu=1, Fri=7, Sat=6 */
export const YAMAGANDA_PERIODS = [5, 4, 3, 2, 1, 7, 6] as const;
